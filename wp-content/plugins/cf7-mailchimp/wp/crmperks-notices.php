...
$msg =sprintf(__('Want to save conatct form 7 submissions? Manage contact form 7 entries , View Mailchimp status of any entry and Send any entry to Mailchimp with free %sConatct Form Entries Plugin%s','crm-perks-forms'),'<a href="https://wordpress.org/plugins/contact-form-entries/" target="_blank">','</a>');
?>
