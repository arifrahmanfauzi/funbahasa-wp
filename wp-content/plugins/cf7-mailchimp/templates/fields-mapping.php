...
<input type="text" name='meta[map][<?php echo esc_attr($k)?>][value]'  id="vx_value_<?php echo esc_attr($k) ?>" value='<?php echo $this->post2($k,'value',$map)?>' placeholder='<?php esc_html_e("Custom Value",'contact-form-mailchimp-crm')?>' class='vx_input_100 vxc_field_input'>
...
<input type="text" name='value'  id="vx_value_"  placeholder="<?php esc_html_e("Custom Value",'contact-form-mailchimp-crm')?>" class="vx_input_100 vxc_field_input">
<div class="howto"><?php echo sprintf(esc_html__('You can add a form field %s in custom value from following form fields','contact-form-mailchimp-crm'),'<code>{field_id}</code>')?></div>
</div>
